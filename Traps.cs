...
public class Traps : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (explosion == true)
        {
            ...
            explosionPos.y = explosionPos.y + 1.1f; //lifts the explosion

            Instantiate(explosionEffect, transform.position, transform.rotation); //spawns explosion // make sure "destroy" on stop is selected in Inspector to prevent looping
