...
***************************************
	...
	*/
    ...
    GameObject movingPlayer = null; // I ADDED THIS     %$#^%#&%^#%^#*&  ////////
    ...
    void OnCollisionEnter(Collision other)
    {
        ...
        //    movingPlayer = other.gameObject;

        //    if (movingPlayer.GetComponent<Rigidbody>() != null)
        //    {



        //        SpeedOfOther = movingPlayer.GetComponent<Rigidbody>().velocity.magnitude; ////////////// ALL FUCKED UP  /////////////////////////////////////////////////
                

        //        //Debug.Log("Speed of Bob " + SpeedOfBob);
        //    }
        ...
        //    Debug.Log(SpeedOfOther);
        //    Debug.Log(SpeedOfSelf);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (movingPlayer.GetComponent<Rigidbody>() != null)
        {
            SpeedOfOther = movingPlayer.GetComponent<Rigidbody>().velocity.magnitude;
        ...
        if (movingPlayer.tag == "Drone") //make sure drone has "Drone" tag
        {
            BreakFunction();
    ...
    IEnumerator Break()
    {
        ...
        if (Replacements.Length > 0)
        {
            ...
            GameObject NewReplacement = Instantiate(Replacements[RandomReplacementNumber], transform.position, transform.rotation, gameObject.transform.parent) as GameObject;
            ///////// HAD TO ENTER gameObject.transform.parent to spawn the shards within the rotating realm of the building....had to make it parent of the window as the windows colliders and rigidbody
            ///////// were disabled due to the other bug of breaking windows
